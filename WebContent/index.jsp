    ...
    <section class="items-grid section custom-padding">
        <div class="container">
            ...
            <div class="single-head">
                <div class="row">
                	<%
                		// 각 챕터 별 챕터, 챕터명, 이동URL, 사용 Source 목록들을 출력하기 위해서 목록 수만큼 반복문 실행
                        ...
                        <div class="single-grid wow fadeInUp" data-wow-delay=".4s">
                            <div class="image">
                                <a href="item-details.html" class="thumbnail">
                                	<img src="${pageContext.request.contextPath }/assets/images/items-grid/img5.jpg" alt="#"></a>
                                <div class="author">
